var express    = require('express'),
    ...
    var dbConn = mongoose.connect(dbConfig.mongoUrl, function(err){
        if(err) debug('MongoDb: Connection error: ' + err.message);
...
//                 deferred.reject('MongoDb: Connection error: ' + err.message);
//             } else { 
//                 dbConn.connection.on('connected', function() {
//                     console.log('Mongoose connected to ' + dbConfig.mongoUrl);
...
//                 dbConn.connection.on('error', function (err) {
//                     console.log('Could not connect to mongo server!' + err.message);
//                     debug('MongoDb: Connection error: ' + err.message);
//                     deferred.reject('MongoDb: Connection error: ' + err.message);
//                 });//----end of error----
